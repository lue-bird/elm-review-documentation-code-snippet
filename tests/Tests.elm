...
"""
        ...
        , Test.test "correctly parenthesizes actual value if necessary"
            (\() ->
                [ """module A exposing (plus1)
    ...
    Test.describe
        ...
        [ Test.describe
            ...
            [ Test.describe
                ...
                [ Test.describe
                    "code snippet 0"
                    [ Test.test "0" (\\() -> (A.plus1 <| 1) |> Expect.equal 2) ]
                ]
            ]
        ]
"""
            ...
            [ Test.describe
                ...
                [ Test.describe
                    ...
                    [ Test.test
                        "0"
                        (\\() ->
                            A.Success 1 |> A.plus1 |> Expect.equal (A.Success 2)
                        )
                    ]
                ]
            ]
...
"""
        ...
        , Test.test "unit equal check edge case"
            (\() ->
                [ """module A exposing (plus1)
